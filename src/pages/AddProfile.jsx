...
export const AddProfile = ({ SetShowInputPopover }) => {
  ...
  async function SubmitForm(e) {
    ...
    var error = false;
    var check = [image, loc, contact, description, occupation]
      ...
      <IonGrid className="shaping" className="gridPadding">
        ...
        <IonCard>
          ...
          <IonRow className="centerInput">
            <IonButton onClick={takePicture} style={{ width: '100%' }} color="primary" expand="full" fill="outline"> Upload pic</IonButton>
          </IonRow>
        ...
        <IonCard>
          <IonRow className="centerInput" style={{ display: 'flex' }}>
            <IonItem style={{ width: '100%' }} color="primary" expand="full" fill="outline">
              <IonLabel>Occupation.</IonLabel>
              <IonSelect onIonChange={e => SetOccupation(e.detail.value)}>
        ...
        <IonCard>
          <IonRow className="centerInput">
            <IonButton onClick={e => SubmitForm(e)} style={{ width: '100%' }} fill="solid" type="submit">Post Event</IonButton>
          </IonRow>
        </IonCard>
